    ...
    const fetchImages = async (forceRefresh = false) => {
      ...
      if (!forceRefresh && cachedData) {
        try {
          ...
          const categoryImages = parsed.filter(img => img.category === 'Group Images');
  ...
  return (
    <div className="pt-32 pb-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <h1 className="section-title text-center mb-4">Group <span className="text-primary-orange">Photos</span></h1>
        <p className="text-center text-gray-600 mb-8 max-w-2xl mx-auto">Capturing the unity and spirit of our St. Merry family through the years.</p>
        ...
        {loading ? (
          ...
          <div className="text-center py-20">
            <p className="text-gray-500 text-lg">No group photos found yet.</p>
          </div>
        ) : (
