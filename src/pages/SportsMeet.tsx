    ...
    const fetchImages = async (forceRefresh = false) => {
      ...
      if (!forceRefresh && cachedData) {
        try {
          ...
          const categoryImages = parsed.filter(img => img.category === 'Sports Meet');
      ...
      try {
        ...
        console.error("Error fetching sports meet photos:", err);
  ...
  return (
    <div className="pt-32 pb-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <Link to="/gallery" className="inline-flex items-center text-primary-orange hover:text-primary-blue transition-colors mb-8 font-bold">
          <ChevronLeft className="mr-2" /> Back to Gallery
        </Link>
        
        <h1 className="section-title text-center mb-4">Sports <span className="text-primary-orange">Meet</span></h1>
        <p className="text-center text-gray-600 mb-8 max-w-2xl mx-auto">Celebrating athleticism, sportsmanship, and the competitive spirit of our champions.</p>
        ...
        {loading ? (
          ...
          <div className="text-center py-20">
            <p className="text-gray-500 text-lg">No sports meet photos found yet.</p>
          </div>
        ) : (
